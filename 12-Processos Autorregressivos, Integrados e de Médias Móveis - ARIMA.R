...
plot(emprego)                                         #Gráfcio dos dados
                       #Insere a linha de regressão linear estimada
...
reglinEMP <- lm(CAMBIO ~ Anos)                       #Regressão linear simples do emprego em relação ao tempo
reglinEMP                                             #Exibe os resultados da regressão linear
summary(reglinEMP)
